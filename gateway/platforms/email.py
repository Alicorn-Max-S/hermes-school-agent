"""
Email platform adapter for the Apollo gateway.

Allows users to interact with Apollo by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Apollo Agent")
        ...
        msg_id = f"<apollo-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
