...
Trust levels:
  - builtin:   Ships with Apollo. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.apollo/\.env|\~/\.apollo/\.env',
     "apollo_env_access", "critical", "exfiltration",
     "directly references Apollo secrets file"),
    ...
    (r'\.apollo/config\.yaml|\.apollo/SOUL\.md',
     "apollo_config_mod", "critical", "persistence",
     "references Apollo configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.apollo/config.yaml."""
    try:
