 ...
 *
 * Usage:
 *   node bridge.js --port 3000 --session ~/.apollo/whatsapp/session
 */
...
const SESSION_DIR = getArg('session', path.join(process.env.HOME || '~', '.apollo', 'whatsapp', 'session'));
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Apollo Agent', 'Chrome', '120.0'],
