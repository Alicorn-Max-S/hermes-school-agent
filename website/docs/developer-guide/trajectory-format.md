...
description: "How Apollo saves trajectories, normalizes tool calls, and produces training-friendly outputs"
---

# Trajectories & Training Format

Apollo can save conversation trajectories for training, evaluation, and batch data generation workflows.
...
Apollo converts live conversation structure into a training-friendly format.
