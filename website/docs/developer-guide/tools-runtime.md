...
Apollo tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. Apollo resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`apollo-cli`, `apollo-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `apollo-acp`
