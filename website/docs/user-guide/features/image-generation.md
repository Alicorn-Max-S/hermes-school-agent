...
Apollo Agent can generate images from text prompts using FAL.ai's **FLUX 2 Pro** model with automatic 2x upscaling via the **Clarity Upscaler** for enhanced quality.
...
When you ask Apollo to generate an image:
...
Simply ask Apollo to create an image:
