...
Apollo Agent supports both text-to-speech output and voice message transcription across all messaging platforms.
...
| CLI | Saved to `~/.apollo/audio_cache/` | MP3 |
...
If your configured provider isn't available, Apollo automatically falls back:
