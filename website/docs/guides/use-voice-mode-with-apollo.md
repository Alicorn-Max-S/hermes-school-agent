---
sidebar_position: 7
title: "Use Voice Mode with Apollo"
description: "A practical guide to setting up and using Apollo voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Apollo
...
- you want Apollo sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Apollo.
...
## Step 1: make sure normal Apollo works first
...
Apollo supports both local and cloud speech stacks.
...
4. Apollo transcribes and responds
...
- asking Apollo to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Apollo loop.

## Tuning CLI behavior

### Silence threshold

If Apollo starts/stops too aggressively, tune:
...
Apollo stays a normal chat bot, but can speak replies.
...
- you want Apollo to function like a portable research or ops assistant
...
Apollo joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Apollo detects speech boundaries
- transcripts are posted in the associated text channel
- Apollo responds in text and audio
...
1. get text Apollo working
2. install `apollo-agent[voice]`
