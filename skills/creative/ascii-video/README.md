...
Built for [Apollo Agent](https://github.com/NousResearch/apollo-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/apollo-agent/skills/creative/ascii-video`](https://github.com/NousResearch/apollo-agent/tree/main/skills/creative/ascii-video) via PR.
