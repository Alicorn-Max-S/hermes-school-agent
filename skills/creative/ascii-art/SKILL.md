...
```bash
python3 -m pyfiglet "APOLLO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=APOLLO&font=Slant" | boxes -d stone
```
