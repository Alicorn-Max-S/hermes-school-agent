...
metadata:
  apollo:
    ...
    related_skills: [claude-code, apollo-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Apollo terminal. Codex is OpenAI's autonomous coding agent CLI.
