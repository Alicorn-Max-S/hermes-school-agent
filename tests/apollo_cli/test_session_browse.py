"""Tests for the interactive session browser (`apollo sessions browse`).
...
from apollo_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """apollo sessions browse should be parseable."""
        from apollo_cli.main import main as _main_entry
