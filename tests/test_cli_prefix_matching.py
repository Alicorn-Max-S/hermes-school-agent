"""Tests for slash command prefix matching in ApolloCLI.process_command."""
...
class TestSlashCommandPrefixMatching:
    ...
    def test_exact_command_with_args_does_not_recurse(self):
        ...
        original_pc = ApolloCLI.process_command
        ...
        with patch.object(ApolloCLI, 'process_command', guarded):
            try:
