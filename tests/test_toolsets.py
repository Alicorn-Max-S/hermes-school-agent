...
class TestResolveToolset:
    def test_leaf_toolset(self):
        ...
        assert set(tools) == {"web_search", "webscrape"}

    def test_composite_toolset(self):
        tools = resolve_toolset("debugging")
        assert "terminal" in tools
        assert "web_search" in tools
        assert "webscrape" in tools
...
class TestToolsetConsistency:
    ...
    def test_apollo_platforms_share_core_tools(self):
        """All apollo-* platform toolsets should have the same tools."""
        platforms = ["apollo-cli", "apollo-telegram", "apollo-discord", "apollo-whatsapp", "apollo-slack", "apollo-signal", "apollo-homeassistant"]
