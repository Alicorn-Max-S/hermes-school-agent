...
class TestWriteDenyExactPaths:
    ...
    def test_apollo_env(self):
        path = os.path.join(str(Path.home()), ".apollo", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_apollo_config_not_env(self):
        path = os.path.join(str(Path.home()), ".apollo", "config.yaml")
