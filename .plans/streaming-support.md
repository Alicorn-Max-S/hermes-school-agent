# Streaming LLM Response Support for Apollo Agent
...
```
APOLLO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("APOLLO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `apollo_cli/config.py` | 1 | +streaming config defaults |
