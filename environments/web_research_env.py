...
Inspired by: GroceryMind — production Apollo agent doing live web research
             across German grocery stores (firecrawl + apollo-agent)
"""
...
# Ensure apollo-agent root is on path
...
class WebResearchEnvConfig(ApolloAgentEnvConfig):
...
class WebResearchEnv(ApolloAgentBaseEnv):
    """
