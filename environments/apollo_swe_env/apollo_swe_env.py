"""
ApolloSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser apollo
    run-api
    python environments/apollo_swe_env.py serve \\
...
class ApolloSweEnv(ApolloAgentBaseEnv):
    ...
    name = "apollo-swe"
    env_config_cls = ApolloSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ApolloSweEnvConfig, List[APIServerConfig]]:
        """
